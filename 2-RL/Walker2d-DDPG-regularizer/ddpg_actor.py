...
class Actor(object):
    ...
    def build_network(self):
        ...
        h1 = Dense(64, kernel_regularizer=regularizers.l2(0.001), activation='relu')(state_input)
        h2 = Dense(32, kernel_regularizer=regularizers.l2(0.001), activation='relu')(h1)
