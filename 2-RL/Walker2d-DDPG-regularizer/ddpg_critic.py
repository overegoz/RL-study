...
class Critic(object):
    ...
    def build_network(self):
        ...
        x1 = Dense(64, kernel_regularizer=regularizers.l2(0.001), activation='relu')(state_input)
        x2 = Dense(32, kernel_regularizer=regularizers.l2(0.001), activation='linear')(x1)

        a1 = Dense(32, kernel_regularizer=regularizers.l2(0.001), activation='relu')(action_input)
        a2 = Dense(16, kernel_regularizer=regularizers.l2(0.001), activation='linear')(a1)

        h2 = concatenate([x2, a2], axis=-1)
        h3 = Dense(16, kernel_regularizer=regularizers.l2(0.001), activation='relu')(h2)
